...
{
  /// <summary>
  /// A no-op <see cref="IAudioDevice" /> for headless environments and testing.
  /// </summary>
  static IAudioDevice Null { get; } = new NullAudioDevice();
  ...
  private sealed class NullAudioDevice : IAudioDevice
  {
