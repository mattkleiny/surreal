...
/// </summary>
public sealed class AsepriteSpriteAnimationSetLoader : AssetLoader<SpriteAnimationSet>
{
  ...
  public override async Task<SpriteAnimationSet> LoadAsync(IAssetContext context, CancellationToken cancellationToken)
  {
