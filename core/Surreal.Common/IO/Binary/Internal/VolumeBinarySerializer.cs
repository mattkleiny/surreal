...
internal sealed class VolumeBinarySerializer : BinarySerializer<Volume>
{
  public override async ValueTask SerializeAsync(Volume value, IBinaryWriter writer, CancellationToken cancellationToken = default)
  {
  ...
  public override async ValueTask<Volume> DeserializeAsync(IBinaryReader reader, CancellationToken cancellationToken = default)
  {
