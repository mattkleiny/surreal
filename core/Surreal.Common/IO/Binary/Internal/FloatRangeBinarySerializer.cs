...
{
  public override async ValueTask SerializeAsync(FloatRange value, IBinaryWriter writer, IBinarySerializationContext context, CancellationToken cancellationToken = default)
  {
    await writer.WriteFloatAsync(value.Min, cancellationToken);
    await writer.WriteFloatAsync(value.Max, cancellationToken);
  }

  public override async ValueTask<FloatRange> DeserializeAsync(IBinaryReader reader, IBinarySerializationContext context, CancellationToken cancellationToken = default)
  {
