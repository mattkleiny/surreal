...
public static class CollectionExtensions
{
  ...
  /// Selects a random element from the given list.
  /// </summary>
  public static T? SelectRandomOrNull<T>(this IReadOnlyList<T> list)
    where T : class
  {
    return SelectRandomOrNull(list, Random.Shared);
  }

  /// <summary>
  /// Selects a random element from the given list.
  /// </summary>
  public static T? SelectRandomOrNull<T>(this IReadOnlyList<T> list, Random random)
    where T : class
  {
    if (list.Count == 0)
    {
  ...
  /// Selects a random element from the given slice.
  /// </summary>
  public static T? SelectRandomOrNull<T>(this ReadOnlySlice<T> slice)
    where T : class
  {
    return SelectRandomOrNull(slice, Random.Shared);
  }

  /// <summary>
  /// Selects a random element from the given slice.
  /// </summary>
  public static T? SelectRandomOrNull<T>(this ReadOnlySlice<T> slice, Random random)
    where T : class
  {
    if (slice.Length == 0)
    {
  ...
  /// Selects a random element from the given <see cref="IEnumerable{T}"/>.
  /// </summary>
  public static T? SelectRandomOrNull<T>(this IEnumerable<T> enumerable)
    where T : class
  {
    return SelectRandomOrNull(enumerable, Random.Shared);
  }

  /// <summary>
  /// Selects a random element from the given <see cref="IEnumerable{T}"/>.
  /// </summary>
  public static T? SelectRandomOrNull<T>(this IEnumerable<T> enumerable, Random random)
    where T : class
  {
    return SelectRandomOrNull(enumerable.ToList(), random);
  }
  ...
  /// Selects a random element from the given <see cref="IEnumerable{T}"/>.
  /// </summary>
  public static bool TrySelectRandom<T>(this IEnumerable<T> enumerable, Random random,
