...
public static class Maths
{
  ...
  public static TimeSpan NextTimeSpan(this Random random)                       => TimeSpan.FromSeconds(random.NextDouble());
  ...
  public static TimeSpan NextRange(this Random random, TimeSpanRange range)     => TimeSpan.FromSeconds(random.NextDouble(range.Min.TotalSeconds, range.Max.TotalSeconds));
