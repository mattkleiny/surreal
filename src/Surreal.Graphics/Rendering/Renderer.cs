...
namespace Surreal.Graphics.Rendering
{
  public abstract class Renderer : IRenderer, IEnumerable<IRenderingPass>, IDisposable
  {
      ...
      in FrameBufferDescriptor depthDescriptor)
    {
      ...
      commandBuffer   = device.Factory.CreateCommandBuffer();
      colorAttachment = device.Factory.CreateFrameBuffer(colorDescriptor);
      depthAttachment = device.Factory.CreateFrameBuffer(depthDescriptor);
    }
